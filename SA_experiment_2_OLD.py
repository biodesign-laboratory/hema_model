...
IHD_out = np.zeros((param_values_IHD.shape[0], 9, 24))      # 24 because want SA results for first 24 hrs after infection begins

print("! Computations starting now !")    # sanity check
...
for i, X in enumerate(param_values_IHD):
    ...
    for x in range(51, 75):
        ...
        IHD_out[i, :, x-51] = output[:, int(x/0.01)]
...
for t in range(51, 75):

    SI_H = sobol_analyze.analyze(problem_IHD, IHD_out[:, 0, t-50])
    SI_N = sobol_analyze.analyze(problem_IHD, IHD_out[:, 1, t-50])
    SI_S = sobol_analyze.analyze(problem_IHD, IHD_out[:, 4, t-50])
    SI_Q = sobol_analyze.analyze(problem_IHD, IHD_out[:, 5, t-50])
    SI_U = sobol_analyze.analyze(problem_IHD, IHD_out[:, 6, t-50])
    SI_I = sobol_analyze.analyze(problem_IHD, IHD_out[:, 8, t-50])
    ...
    total_Si_H.to_csv(f'total_Si_H_2_{t}.csv', sep='\t')
    first_Si_H.to_csv(f'first_Si_H_2_{t}.csv', sep='\t')
    second_Si_H.to_csv(f'second_Si_H_2_{t}.csv', sep='\t')

    total_Si_N.to_csv(f'total_Si_N_2_{t}.csv', sep='\t')
    first_Si_N.to_csv(f'first_Si_N_2_{t}.csv', sep='\t')
    second_Si_N.to_csv(f'second_Si_N_2_{t}.csv', sep='\t')

    total_Si_S.to_csv(f'total_Si_S_2_{t}.csv', sep='\t')
    first_Si_S.to_csv(f'first_Si_S_2_{t}.csv', sep='\t')
    second_Si_S.to_csv(f'second_Si_S_2_{t}.csv', sep='\t')

    total_Si_Q.to_csv(f'total_Si_Q_2_{t}.csv', sep='\t')
    first_Si_Q.to_csv(f'first_Si_Q_2_{t}.csv', sep='\t')
    second_Si_Q.to_csv(f'second_Si_Q_2_{t}.csv', sep='\t')

    total_Si_U.to_csv(f'total_Si_U_2_{t}.csv', sep='\t')
    first_Si_U.to_csv(f'first_Si_U_2_{t}.csv', sep='\t')
    second_Si_U.to_csv(f'second_Si_U_2_{t}.csv', sep='\t')

    total_Si_I.to_csv(f'total_Si_I_2_{t}.csv', sep='\t')
    first_Si_I.to_csv(f'first_Si_I_2_{t}.csv', sep='\t')
    second_Si_I.to_csv(f'second_Si_I_2_{t}.csv', sep='\t')
...
total_Si_H.to_csv('total_Si_H_2.csv', sep='\t')
first_Si_H.to_csv('first_Si_H_2.csv', sep='\t')
second_Si_H.to_csv('second_Si_H_2.csv', sep='\t')

total_Si_N.to_csv('total_Si_N_2.csv', sep='\t')
first_Si_N.to_csv('first_Si_N_2.csv', sep='\t')
second_Si_N.to_csv('second_Si_N_2.csv', sep='\t')

total_Si_S.to_csv('total_Si_S_2.csv', sep='\t')
first_Si_S.to_csv('first_Si_S_2.csv', sep='\t')
second_Si_S.to_csv('second_Si_S_2.csv', sep='\t')

total_Si_Q.to_csv('total_Si_Q_2.csv', sep='\t')
first_Si_Q.to_csv('first_Si_Q_2.csv', sep='\t')
second_Si_Q.to_csv('second_Si_Q_2.csv', sep='\t')

total_Si_U.to_csv('total_Si_U_2.csv', sep='\t')
first_Si_U.to_csv('first_Si_U_2.csv', sep='\t')
second_Si_U.to_csv('second_Si_U_2.csv', sep='\t')

total_Si_I.to_csv('total_Si_I_2.csv', sep='\t')
first_Si_I.to_csv('first_Si_I_2.csv', sep='\t')
second_Si_I.to_csv('second_Si_I_2.csv', sep='\t')'''
