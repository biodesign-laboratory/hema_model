...
read_from_hyper_loc = Path.cwd() / 'presets' / 'hyper_preset_recovery_septic_1.csv'         # .csv containing hyperparameters to read from, put the path here
read_from_param_loc = Path.cwd() / 'presets' / 'parameter_preset_recovery_septic_1.csv'        # .csv containing model paramaters to read from, put the path here
read_from_init_loc = Path.cwd() / 'presets' / 'init_val_preset_recovery_septic_1.csv'         # .csv containing model initial values to read from, put the path here
...
if plot_chronic:
    ...
    for i in range(runs):
        ...
        chronic_test_arr = np.array(PL.chronic_infection_flagger(1_000, 200_000, 3000, 0.01, outputs[i, 2], derivatives[i, 2]))
